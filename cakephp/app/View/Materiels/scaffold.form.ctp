...
<?php
	...
	echo $this->Form->input('organisme', array('options' => array('UPS'=> 'UPS', 'CNRS' => 'CNRS'), 'style' => 'width: 100px'));
	...
	echo $this->Form->input('lieu_stockage', array('label' => 'Lieu de stockage', 'options' => array('B'=>'Belin', 'R'=>'Roche', 'T'=>'Tarbes', 'C'=>'CNES', 'A'=>'Autre'), 'style' => 'width: 100px'));
	...
	echo $this->Form->input('eotp', array('label' => 'EOTP (Centre de crédit)', 'style' => 'width: 100px', 'options' => array('Xlab'=>'Xlab', 'SIFAC'=> 'SIFAC')));
	...
	if ($this->params['action'] == 'add') {
		echo $this->Form->input('nom_responsable', array('label' => 'Nom du responsable', 'value' => $this->Session->read('LdapUserName'), 'readonly' => true));
		echo $this->Form->input('email_responsable', array('label' => 'Email du responsable', 'value' => $this->Session->read('LdapUserMail'), 'readonly' => true));
	}
