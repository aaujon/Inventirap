...
-- -----------------------------------------------------
-- Table `mydb`.`groupes_travail`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`groupes_travail` ;

CREATE  TABLE IF NOT EXISTS `mydb`.`groupes_travail` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `nom` VARCHAR(45) NULL ,
  PRIMARY KEY (`id`) )
ENGINE = InnoDB;
...
CREATE  TABLE IF NOT EXISTS `mydb`.`materiels` (
  ...
  CONSTRAINT `fk_materials_work_group1`
    ...
    REFERENCES `mydb`.`groupes_travail` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Data for table `mydb`.`groupes_travail`
-- -----------------------------------------------------
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`groupes_travail` (`id`, `nom`) VALUES (1, 'N/A');
INSERT INTO `mydb`.`groupes_travail` (`id`, `nom`) VALUES (2, 'GEDI');
INSERT INTO `mydb`.`groupes_travail` (`id`, `nom`) VALUES (3, 'GT2I');
INSERT INTO `mydb`.`groupes_travail` (`id`, `nom`) VALUES (4, 'GI');
INSERT INTO `mydb`.`groupes_travail` (`id`, `nom`) VALUES (5, 'GACL');
INSERT INTO `mydb`.`groupes_travail` (`id`, `nom`) VALUES (6, 'GGPAQ');
INSERT INTO `mydb`.`groupes_travail` (`id`, `nom`) VALUES (7, 'GM');
