...
//  Inventirap
//
//  Converted by Thomas Zilio on 28/07/12 from the Apple original KeychainWrapper.m.
...
- (NSMutableDictionary *)secItemFormatToDictionary:(NSDictionary *)dictionaryToConvert
{
    ...
    if (SecItemCopyMatching((__bridge CFDictionaryRef)returnDictionary, &foundDict) == noErr)
    {
        // Remove the search, class, and identifier key/value, we don't need them anymore.
        [returnDictionary removeObjectForKey:(__bridge id)kSecReturnData];
        
		passwordData = (__bridge_transfer NSData *)foundDict;
